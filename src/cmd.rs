...
pub fn handle_seek<P: AsRef<Path>>(ffmpeg_args: &mut Vec<String>, input: P, seek: &Option<String>) {
	if let Some(ss) = seek {
...
pub fn handle_duration(ffmpeg_args: &mut Vec<String>, seek: &Option<String>, duration: &Option<String>, duration_to: &Option<String>) {
	let mut s = 0_f64;
	if let Some(ss) = seek {
