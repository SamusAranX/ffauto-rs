...
pub struct ProgramArgs {
	...
	#[clap(short = 'T', long, help = "Performs an HDR-to-SDR tonemap")]
	pub tonemap: bool,
	#[clap(short = 'F', long, default_value_t = true, help = "Moves moov atom to the start")]
	pub faststart: bool,
	...
	#[clap(long = "vw", group = "resize", help = "Sets the output video width, preserving aspect ratio.")]
	pub width: Option<u64>,
	#[clap(long = "vh", group = "resize", help = "Sets the output video height, preserving aspect ratio.")]
	...
	#[clap(short, long, help = "Crops the output video. Format WxH or WxH,X;Y. (applied before scaling)")]
	pub crop: Option<String>,

	#[clap(short = 'r', long, help = "Sets the output video frame rate.")]
	pub framerate: Option<f64>,

	#[clap(short = 'C', long = "codec", help = "The video codec", default_value_t = VideoCodec::default())]
	pub video_codec: VideoCodec,
	#[clap(short, long, help = "The encoder preset", default_value_t = Preset::default())]
	pub preset: Preset,

	#[clap(short, help = "Reduces video quality depending on how often this was specified", action = ArgAction::Count)]
	pub garbage: u8,
...
impl ProgramArgs {
	...
	pub fn needs_video_filter(&self) -> bool {
		self.width.is_some() || self.height.is_some() || self.fade != 0.0 || self.fade_in != 0.0 || self.fade_out != 0.0 ||
			self.crop.is_some() || self.framerate.is_some() || self.tonemap
	}
}