...
pub fn get_builtin_palette(pal: &BuiltInPalette) -> Palette {
	match pal {
		...
		BuiltInPalette::Blues => Palette::from_json_string(include_str!("palettes/gradient-rs/blues.json")).unwrap(),
		BuiltInPalette::BrBg => Palette::from_json_string(include_str!("palettes/gradient-rs/br-bg.json")).unwrap(),
		BuiltInPalette::BuGn => Palette::from_json_string(include_str!("palettes/gradient-rs/bu-gn.json")).unwrap(),
		BuiltInPalette::BuPu => Palette::from_json_string(include_str!("palettes/gradient-rs/bu-pu.json")).unwrap(),
		BuiltInPalette::Cividis => Palette::from_json_string(include_str!("palettes/gradient-rs/cividis.json")).unwrap(),
		BuiltInPalette::Cool => Palette::from_json_string(include_str!("palettes/gradient-rs/cool.json")).unwrap(),
		BuiltInPalette::Cubehelix => Palette::from_json_string(include_str!("palettes/gradient-rs/cubehelix.json")).unwrap(),
		BuiltInPalette::GnBu => Palette::from_json_string(include_str!("palettes/gradient-rs/gn-bu.json")).unwrap(),
		BuiltInPalette::Greens => Palette::from_json_string(include_str!("palettes/gradient-rs/greens.json")).unwrap(),
		BuiltInPalette::Inferno => Palette::from_json_string(include_str!("palettes/gradient-rs/inferno.json")).unwrap(),
		BuiltInPalette::Magma => Palette::from_json_string(include_str!("palettes/gradient-rs/magma.json")).unwrap(),
		BuiltInPalette::OrRd => Palette::from_json_string(include_str!("palettes/gradient-rs/or-rd.json")).unwrap(),
		BuiltInPalette::Oranges => Palette::from_json_string(include_str!("palettes/gradient-rs/oranges.json")).unwrap(),
		BuiltInPalette::PiYg => Palette::from_json_string(include_str!("palettes/gradient-rs/pi-yg.json")).unwrap(),
		BuiltInPalette::Plasma => Palette::from_json_string(include_str!("palettes/gradient-rs/plasma.json")).unwrap(),
		BuiltInPalette::PrGn => Palette::from_json_string(include_str!("palettes/gradient-rs/pr-gn.json")).unwrap(),
		BuiltInPalette::PuBu => Palette::from_json_string(include_str!("palettes/gradient-rs/pu-bu.json")).unwrap(),
		BuiltInPalette::PuBuGn => Palette::from_json_string(include_str!("palettes/gradient-rs/pu-bu-gn.json")).unwrap(),
		BuiltInPalette::PuOr => Palette::from_json_string(include_str!("palettes/gradient-rs/pu-or.json")).unwrap(),
		BuiltInPalette::PuRd => Palette::from_json_string(include_str!("palettes/gradient-rs/pu-rd.json")).unwrap(),
		BuiltInPalette::Purples => Palette::from_json_string(include_str!("palettes/gradient-rs/purples.json")).unwrap(),
		BuiltInPalette::Rainbow => Palette::from_json_string(include_str!("palettes/gradient-rs/rainbow.json")).unwrap(),
		BuiltInPalette::RdBu => Palette::from_json_string(include_str!("palettes/gradient-rs/rd-bu.json")).unwrap(),
		BuiltInPalette::RdGy => Palette::from_json_string(include_str!("palettes/gradient-rs/rd-gy.json")).unwrap(),
		BuiltInPalette::RdPu => Palette::from_json_string(include_str!("palettes/gradient-rs/rd-pu.json")).unwrap(),
		BuiltInPalette::RdYlBu => Palette::from_json_string(include_str!("palettes/gradient-rs/rd-yl-bu.json")).unwrap(),
		BuiltInPalette::RdYlGn => Palette::from_json_string(include_str!("palettes/gradient-rs/rd-yl-gn.json")).unwrap(),
		BuiltInPalette::Reds => Palette::from_json_string(include_str!("palettes/gradient-rs/reds.json")).unwrap(),
		BuiltInPalette::Sinebow => Palette::from_json_string(include_str!("palettes/gradient-rs/sinebow.json")).unwrap(),
		BuiltInPalette::Spectral => Palette::from_json_string(include_str!("palettes/gradient-rs/spectral.json")).unwrap(),
		BuiltInPalette::Turbo => Palette::from_json_string(include_str!("palettes/gradient-rs/turbo.json")).unwrap(),
		BuiltInPalette::Viridis => Palette::from_json_string(include_str!("palettes/gradient-rs/viridis.json")).unwrap(),
		BuiltInPalette::Warm => Palette::from_json_string(include_str!("palettes/gradient-rs/warm.json")).unwrap(),
		BuiltInPalette::YlGn => Palette::from_json_string(include_str!("palettes/gradient-rs/yl-gn.json")).unwrap(),
		BuiltInPalette::YlGnBu => Palette::from_json_string(include_str!("palettes/gradient-rs/yl-gn-bu.json")).unwrap(),
		BuiltInPalette::YlOrBr => Palette::from_json_string(include_str!("palettes/gradient-rs/yl-or-br.json")).unwrap(),
		BuiltInPalette::YlOrRd => Palette::from_json_string(include_str!("palettes/gradient-rs/yl-or-rd.json")).unwrap(),
