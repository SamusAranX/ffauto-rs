...
pub enum BuiltInPalette {
	...
	Macintosh,
	Websafe,
	Grayscale, // all 256 gray levels
	Monochrome, // just black and white
...
pub fn get_builtin_palette(pal: &BuiltInPalette) -> Palette {
	match pal {
		...
		BuiltInPalette::UniformPs => Palette::from_hex_string(include_str!("palettes/photoshop_uniform.hex")).unwrap(),

		BuiltInPalette::UniformAseprite => Palette::from_hex_string(include_str!("palettes/uniform_aseprite.hex")).unwrap(),
		BuiltInPalette::UniformFfmpeg => Palette::from_hex_string(include_str!("palettes/uniform_ffmpeg.hex")).unwrap(),
		BuiltInPalette::UniformPerceptual => Palette::from_hex_string(include_str!("palettes/uniform_perceptual.hex")).unwrap(),
		BuiltInPalette::UniformSelective => Palette::from_hex_string(include_str!("palettes/uniform_selective.hex")).unwrap(),
