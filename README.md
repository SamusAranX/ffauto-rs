...
Audio is copied without re-encoding when the source is already AAC and no audio filters are needed. Otherwise it is encoded to AAC at 256 kbps.
...
Options:
  ...
  -p, --palette-file <PALETTE_FILE>
          A file containing a palette. (supports ACT, COL, GPL, HEX, and PAL formats)
  -P, --palette-name <PALETTE_NAME>
          A built-in palette [possible values: cmyk, windows, macintosh, websafe, grayscale, monochrome, uniform-ps, uniform-aseprite, uniform-ffmpeg, uniform-perceptual, uniform-selective, blues, br-bg, bu-gn, bu-pu, cividis, cool, cubehelix, gn-bu, greens, inferno, magma, or-rd, oranges, pi-yg, plasma, pr-gn, pu-bu, pu-bu-gn, pu-or, pu-rd, purples, rainbow, rd-bu, rd-gy, rd-pu, rd-yl-bu, rd-yl-gn, reds, sinebow, spectral, turbo, viridis, warm, yl-gn, yl-gn-bu, yl-or-br, yl-or-rd, aap64, aap-micro12, aap-radiant-xv, aap-splendor128, simple-jpc16, a64, arne16, arne32, cg-arne, copper-tech, cpc-boy, eroge-copper, jmp, psygnosia, matriax8c, db8, db16, db32, arq4, arq16, edg8, edg16, edg32, en4, enos16, hept32, apple-ii, atari2600-ntsc, atari2600-pal, cga, cga0, cga0-high, cga1, cga1-high, cga3rd, cga3rd-high, commodore-plus4, commodore-vic20, commodore64, cpc, gameboy, gameboy-color, master-system, msx1, msx2, nes, nes-ntsc, teletext, vga13h, virtual-boy, zx-spectrum, mail24, nyx8, pico8, bubblegum16, rosy42, google-ui, minecraft, monokai, smile-basic, solarized, win16, x11, zughy32]
  -n <NUM_COLORS>
          The number of colors in the generated palette [default: 256]
      --stats-mode <STATS_MODE>
          The statistics mode. (palettegen) [default: full] [possible values: full, diff, single]
  -D, --dither <DITHER>
          The dithering mode. (paletteuse) [default: sierra2_4a] [possible values: bayer, heckbert, floyd-steinberg, sierra2, sierra2-4a, sierra3, burkes, atkinson, none]
...
At most one palette source may be specified. When none is given, a palette is generated from the video itself.

[Click here for a list of built-in palettes with visualizations.](PALETTES.md)

* `-p/--palette-file <PALETTE_FILE>`: Load a palette from a file. Supported formats: ACT, COL, GPL, HEX, PAL.
* `-P/--palette-name <PALETTE_NAME>`: Use a built-in palette. Includes hardware palettes (`gameboy`, `nes`, `cga`, `commodore64`, `zx-spectrum`, …), pixel art palettes (`db16`, `db32`, `pico8`, `arne32`, …), and scientific gradient palettes (`viridis`, `inferno`, `turbo`, `plasma`, …).
* `-n <NUM_COLORS>`: Maximum number of colors to generate when building a palette automatically. Default: `256`.
...
Options:
  ...
  -S, --scale-mode <SCALE_MODE>      Sets the scaling algorithm used [default: bicubic] [possible values: fast-bilinear, bilinear, bicubic, neighbor, area, bicublin, gauss, sinc, lanczos, spline]
      ...
      --saturation <SATURATION>      Affects the output saturation, range [0.0;3.0] [default: 1]
      --sharpness <SHARPNESS>        Affects the output sharpness, range [-1.5;1.5] [default: 0]
  -p, --palette-file <PALETTE_FILE>  A file containing a palette in either ACT, COL, GPL, HEX, JSON, or PAL format
  -P, --palette-name <PALETTE_NAME>  A built-in palette [possible values: cmyk, windows, macintosh, websafe, grayscale, monochrome, uniform-ps, uniform-aseprite, uniform-ffmpeg, uniform-perceptual, uniform-selective, blues, br-bg, bu-gn, bu-pu, cividis, cool, cubehelix, gn-bu, greens, inferno, magma, or-rd, oranges, pi-yg, plasma, pr-gn, pu-bu, pu-bu-gn, pu-or, pu-rd, purples, rainbow, rd-bu, rd-gy, rd-pu, rd-yl-bu, rd-yl-gn, reds, sinebow, spectral, turbo, viridis, warm, yl-gn, yl-gn-bu, yl-or-br, yl-or-rd, aap64, aap-micro12, aap-radiant-xv, aap-splendor128, simple-jpc16, a64, arne16, arne32, cg-arne, copper-tech, cpc-boy, eroge-copper, jmp, psygnosia, matriax8c, db8, db16, db32, arq4, arq16, edg8, edg16, edg32, en4, enos16, hept32, apple-ii, atari2600-ntsc, atari2600-pal, cga, cga0, cga0-high, cga1, cga1-high, cga3rd, cga3rd-high, commodore-plus4, commodore-vic20, commodore64, cpc, gameboy, gameboy-color, master-system, msx1, msx2, nes, nes-ntsc, teletext, vga13h, virtual-boy, zx-spectrum, mail24, nyx8, pico8, bubblegum16, rosy42, google-ui, minecraft, monokai, smile-basic, solarized, win16, x11, zughy32]
  -n <NUM_COLORS>                    The number of colors in the generated palette [default: 256]
  -D, --dither <DITHER>              The dithering mode (paletteuse) [default: sierra2-4a] [possible values: bayer, heckbert, floyd-steinberg, sierra2, sierra2-4a, sierra3, burkes, atkinson, none]
      --bayer-scale <BAYER_SCALE>    The bayer pattern scale in the range [0;5] (paletteuse) [default: 2]
...
Options:
  ...
  -D, --deep-color                   Outputs a 48-bit PNG
      --vh <HEIGHT>                  Sets the output barcode image's height
  -h, --help                         Print help
```
...
![An animated GIF using the four-color Game Boy palette](images/destroyer_gameboy.gif)
</details>
...
![A static image using 16 colors and Bayer dithering](images/destroyer16.png)
</details>
...
![A movie barcode in "colors" mode](images/barcode_colors.png)
</details>
...
```sh
ff gif -i input.mp4 -t 4 --vh 360 -P gameboy -D bayer output.gif
```

### Quantize a still image to 16 colors using Floyd-Steinberg dithering
```sh
ff quant -i input.png -n 16 -D floyd-steinberg output.png
```
